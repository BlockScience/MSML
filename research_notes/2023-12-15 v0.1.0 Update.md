...
1. [MSML Repository](https://github.com/DynamicalSystemsGroup/MSML): The core repository hosting the library
2. [GDS-cadCAD-MSML Repository](https://github.com/DynamicalSystemsGroup/GDS-MSML-cadCAD): The repository hosting some joint shared resources such as canonical examples (WIP) and documentation (WIP)
...
4. [Pocket Network Math Spec](https://github.com/DynamicalSystemsGroup/PocketMathSpec): A successful example of use of the math spec on a client project to deliver a mathematical specification

### Github Project Plans
1. [V0.2 Project Plan](https://github.com/orgs/DynamicalSystemsGroup/projects/21)
2. [V0.3 Project Plan](https://github.com/orgs/DynamicalSystemsGroup/projects/22)
...
7. A full wrangling/triaging of github issues into two project plans associated with version launches:
    A. [V0.2 Project Plan](https://github.com/orgs/DynamicalSystemsGroup/projects/21)
    B. [V0.3 Project Plan](https://github.com/orgs/DynamicalSystemsGroup/projects/22)
...
- Improve documentation to [GDS-cadCAD-MSML Repository](https://github.com/DynamicalSystemsGroup/GDS-MSML-cadCAD): The repository hosting some joint shared resources such as canonical examples (WIP) and documentation (WIP)
